...
public interface DBAppInterface {
    ...
    void createIndex(String tableName, String[] columnNames) throws DBAppException, IOException, ClassNotFoundException;
    ...
    Iterator selectFromTable(SQLTerm[] sqlTerms, String[] arrayOperators) throws DBAppException, ParseException;
